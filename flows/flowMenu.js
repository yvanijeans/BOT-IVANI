    ...
    switch (ctx.body) {
        case '1':
          ...
          await provider.vendor.sendMessage(id, {
            text: '❤❤ _*PRECIOS DE NUESTROS PRODUCTOS EN EL CATALOGO*_ \n💎💎 _SON PRECIOS POR MAYOR 6 PRENDAS A MAS_',
            contextInfo: {
              externalAdReply: {
        ...
        case '2':
          await sendReaction(provider, ctx, "❤️");
          await typing(provider, ctx, 2000);
          await flowDynamic('❤️👑 _*ADJUNTAMOS CATÁLOGO EN PDF. LIMPIO SIN LOGOS NI MARCA PARA QUE ENVÍES A TUS CLIENTES DE FORMA DIRECTA*_ 👑❤️?\n\n📝 _*RECUERDA QUE EL PEDIDO MÍNIMO ES DE 6 PRENDAS A MAS.*_\n\n✅ _*SOLO VENDEMOS POR MAYOR*_')
          await typing(provider, ctx, 1000);
          await flowDynamic('📝 _*RECUERDA QUE EL PEDIDO MÍNIMO ES DE 6 PRENDAS A MAS.*_\n( _si deseas llevar 3 prendas le sumamos 10soles adicional por prenda_ )')
          await typing(provider, ctx, 1000);
          await flowDynamic('✅ _*SOLO VENDEMOS POR MAYOR*_')
          await typing(provider, ctx, 2000);
          await flowDynamic([{
        ...
        case '3':
          await sendReaction(provider, ctx, "❤️");
          await typing(provider, ctx, 2000);
          await flowDynamic('✅  _*CONTAMOS CON DOS TIENDAS MAYORISTAS DE FULL JEANS  EN GAMARRA*_ 🎀')
          await typing(provider, ctx, 1000);
          await flowDynamic('✅ _*HACEMOS VIDEOLLADAS DESDE LAS 10 AM PARA SEGURIDAD EN SU COMPRA*_ 🤗')
          await typing(provider, ctx, 1000);
          await flowDynamic('✅ _*PUEDES BUSCARNOS EN GOOGLE MAPS COMO IVANI JEANS   O TBM INGRESAR DESDE NUESTRO LINK DIRECTO*_  👇👇👇🙋🏼')
          await typing(provider, ctx, 2000);
          await provider.sendLocation( id, "-12.0615018", "-77.0156008")
          typing(provider, ctx, 3000);
          await flowDynamic([{
            body: '✅ _*Ubicanos en galería guisado de av 28 de julio con HUANUCO 2496.❤️PRIMER PISO👉 NUMERO #108*_ 💎💎💎',
        ...
        case '7':
          await sendReaction(provider, ctx, "❤️");
          await typing(provider, ctx, 2000);
          await flowDynamic('Estamos en proceso de contactar a un asesor y se comunicará contigo en breve. 📞✨😊')
